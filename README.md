# Frontend Mentor - Card de resumo do pedido

![Prévia do design do desafio de código Card de resumo do pedido](preview.jpg)
...
Seu desafio é construir este componente de card de resumo do pedido e deixá-lo o mais próximo possível do design.
